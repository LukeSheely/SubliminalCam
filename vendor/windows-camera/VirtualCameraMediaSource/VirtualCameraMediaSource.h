...
static LPCWSTR VIRTUALCAMERAMEDIASOURCE_CLSID = L"{D0B7E14A-ED7D-4C2F-9B34-517D5AA37190}";
static LPCWSTR VIRTUALCAMERAMEDIASOURCE_FRIENDLYNAME = L"SubliminalCam Media Source";
